...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default="HalfCheetahDir-v0")
    ...
    parser.add_argument('--num_train_tasks', type=int, default=2)
    ...
    parser.add_argument('--dt_lr', type=float, default=6e-6)
