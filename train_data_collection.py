...
from configs import args_point_robot, args_half_cheetah_vel, args_ant_dir, args_walker, args_half_cheetah_dir, args_reach, args_hopper
from src.envs import HalfCheetahVelEnv, AntDirEnv, WalkerRandParamsWrappedEnv, PointEnv, ReachEnv, HopperRandParamsEnv, HalfCheetahDirEnv

parser = argparse.ArgumentParser()
parser.add_argument('--env_type', default='hopper')
...
# save goal positions of all tasks
if env_type=='point_robot':
...
for task_id in range(split_idx, split_idx + split_step):
