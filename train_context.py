...
import environments 
from src.envs import  HalfCheetahVelEnv,AntDirEnv,WalkerRandParamsWrappedEnv,ReachEnv,HalfCheetahDirEnv,HopperRandParamsEnv
...
env.seed(args.seed)
if ((env_type!='walker_para')and(env_type!='hopper')):
